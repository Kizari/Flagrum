...
var bytes = File.ReadAllBytes(@"C:\Users\Kieran\Desktop\r_cc_a2_lp_0000a_facial.ani");
var clip = AnimationClip.FromData(bytes);
clip.KeyFrames[0].PackedKeys[0].Unpack();
