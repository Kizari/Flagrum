...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        //         if (text.Contains("uhcloth_00_pat_00_b", StringComparison.OrdinalIgnoreCase))
        //         {
        //             System.Console.WriteLine(file.Uri);
        //         }
        //     },
        ...
        //     file =>
        //     {
        //         var reader = new MaterialReader(file.GetData()).Read();
        //         if (reader.Textures.Any(t => t.Path.Contains("uhcloth_00_pat_00_b")))
        //         {
        //             System.Console.WriteLine(file.Uri);
        //         }
        //     },
