...
public class DataMigrationSourceGenerator : IIncrementalGenerator
{
    ...
    {
        // Migrations only belong in the core application
        if (compilation.AssemblyName != "Flagrum")
        {
            return;
        }
        ...
        foreach (var classDeclaration in classDeclarations)
        {
            ...
            classes.Add($"{nameSpace}.{className}");
        ...
        var staticSource = $$"""
                             ...
                             public static class SteppedMigrationExtensions
                             {
                                  public static IServiceCollection AddDataMigrations(this IServiceCollection services) => services
                                      {{string.Join("\r\n        ", classes.Select(c => $".AddTransient<{c}>()"))}};
                             }
                             """;
