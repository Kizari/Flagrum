...
namespace Black.Sequence.Action.Base
{
    ...
    public partial class SequenceActionRaycastBase : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
		...
		public SQEX.Ebony.Framework.Node.GraphVariableInputPin startVectPin_= new SQEX.Ebony.Framework.Node.GraphVariableInputPin();
		public SQEX.Ebony.Framework.Node.GraphVariableInputPin endVectPin_= new SQEX.Ebony.Framework.Node.GraphVariableInputPin();
		public SQEX.Ebony.Framework.Node.GraphVariableOutputPin outValueHitActor_= new SQEX.Ebony.Framework.Node.GraphVariableOutputPin();
		public SQEX.Ebony.Framework.Node.GraphVariableOutputPin outValueHitVector_= new SQEX.Ebony.Framework.Node.GraphVariableOutputPin();
		public SQEX.Ebony.Framework.Node.GraphVariableOutputPin outValueHitNormal_= new SQEX.Ebony.Framework.Node.GraphVariableOutputPin();
		public SQEX.Ebony.Framework.Node.GraphVariableOutputPin outValueHitDistance_= new SQEX.Ebony.Framework.Node.GraphVariableOutputPin();
