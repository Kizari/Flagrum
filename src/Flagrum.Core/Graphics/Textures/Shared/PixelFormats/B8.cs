...
public struct B8 : IPixel<B8>
{
    public byte B;

    public PixelOperations<B8> CreatePixelOperations() => throw new NotImplementedException();
    ...
    public bool Equals(B8 other) => throw new NotImplementedException();
}