...
public struct GR16 : IPixel<GR16>
{
    public byte G;
    public byte R;

    public PixelOperations<GR16> CreatePixelOperations() => throw new NotImplementedException();
    ...
    public bool Equals(GR16 other) => throw new NotImplementedException();
}