    ...
    ApplicationHost application)
{
    ...
    {
        application.SetSplashText("Migrating file index");
        ...
        application.SetSplashText("Cleaning up old data");
    ...
    {
        application.SetSplashText("Migrating mod projects");
        ...
        application.SetSplashText("Reenabling mods");
