...
public class Fmod
{
    ...
    public static Fmod FromEarcMod(EarcMod mod, string thumbnailPath)
    {
        var fmod = new Fmod
        {
                ...
                Files = e.Files.Select(f => new FmodEarcFile
                {
                    ...
                    DataSource = f.Type is EarcFileChangeType.Remove or EarcFileChangeType.AddReference
                        ...
                        : f.ReplacementFilePath.EndsWith(".ffg")
                            ...
                            : $@"{Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData)}\Temp\Flagrum\cache\{mod.Id}{f.Id}{Cryptography.HashFileUri64(f.Uri)}.ffg"
                }).ToArray(),
