...
namespace Black.Sequence.Action.Actor.AI.AIMode
{
    ...
    public partial class SequenceActionExecLeviaMode : Black.Sequence.Action.Actor.AI.AIMode.SequenceActionExecAIModeBase
    {
		...
		public SQEX.Ebony.Framework.Node.GraphVariableInputPin aiSubModeIdIPin_= new SQEX.Ebony.Framework.Node.GraphVariableInputPin();
		public SQEX.Ebony.Framework.Node.GraphVariableInputPin moveTpsQueryIdIPin_= new SQEX.Ebony.Framework.Node.GraphVariableInputPin();
		public SQEX.Ebony.Framework.Node.GraphVariableInputPin attackTpsQueryIdIPin_= new SQEX.Ebony.Framework.Node.GraphVariableInputPin();
		public SQEX.Ebony.Framework.Node.GraphVariableInputPin searchLabelIdIPin_= new SQEX.Ebony.Framework.Node.GraphVariableInputPin();
		public SQEX.Ebony.Framework.Node.GraphVariableInputPin basePointIPin_= new SQEX.Ebony.Framework.Node.GraphVariableInputPin();
		public SQEX.Ebony.Framework.Node.GraphVariableInputPin basePositionIPin_= new SQEX.Ebony.Framework.Node.GraphVariableInputPin();
		public SQEX.Ebony.Framework.Node.GraphVariableInputPin baseRadiusIPin_= new SQEX.Ebony.Framework.Node.GraphVariableInputPin();
