...
namespace Black.Sequence.Action.Camera.ObjectiveCamera
{
    ...
    public partial class SequenceActionObjectiveCameraGetOffset : SQEX.Ebony.Framework.Sequence.SequenceAction
    {
		...
		public SQEX.Ebony.Framework.Node.GraphVariableOutputPin eyeOffsetPin_= new SQEX.Ebony.Framework.Node.GraphVariableOutputPin();
		public SQEX.Ebony.Framework.Node.GraphVariableOutputPin pogOffsetYPin_= new SQEX.Ebony.Framework.Node.GraphVariableOutputPin();
		public SQEX.Ebony.Framework.Node.GraphVariableOutputPin pogOffsetXPin_= new SQEX.Ebony.Framework.Node.GraphVariableOutputPin();
		public SQEX.Ebony.Framework.Node.GraphVariableOutputPin pogOffsetPin_= new SQEX.Ebony.Framework.Node.GraphVariableOutputPin();
