...
namespace Black.Sequence.Actor
{
    ...
    public partial class SequenceActionInteraction : Black.Sequence.Actor.SequenceActionActorStatusBase
    {
		...
		public SQEX.Ebony.Framework.Node.GraphTriggerOutputPin interact_= new SQEX.Ebony.Framework.Node.GraphTriggerOutputPin();
		public SQEX.Ebony.Framework.Node.GraphTriggerOutputPin interact_camera_= new SQEX.Ebony.Framework.Node.GraphTriggerOutputPin();
		public SQEX.Ebony.Framework.Node.GraphTriggerOutputPin action_= new SQEX.Ebony.Framework.Node.GraphTriggerOutputPin();
		public SQEX.Ebony.Framework.Node.GraphTriggerOutputPin action_camera_= new SQEX.Ebony.Framework.Node.GraphTriggerOutputPin();
		public SQEX.Ebony.Framework.Node.GraphTriggerOutputPin cancel_= new SQEX.Ebony.Framework.Node.GraphTriggerOutputPin();
		public SQEX.Ebony.Framework.Node.GraphTriggerOutputPin cancel_camera_= new SQEX.Ebony.Framework.Node.GraphTriggerOutputPin();
