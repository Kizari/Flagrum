...
//         {
//             var newNode = new StandardNode(counter++, Type.GetType(node.Type), new Point(node.X, node.Y));
...
//     {
//         var node = new StandardNode(0, typeof(SequenceEventSequenceStarted), new Point(300, 50));
//         diagram.Nodes.Add(node);
//         node = new StandardNode(1, typeof(SequenceActionControlIf), new Point(300, 50));
//         diagram.Nodes.Add(node);
//         node = new StandardNode(2, typeof(SequenceActionEventScriptRegisterActor), new Point(300, 50));
//         diagram.Nodes.Add(node);
//         node = new StandardNode(3, typeof(SequenceActionActorCheckTag), new Point(300, 50));
//         diagram.Nodes.Add(node);
//         node = new StandardNode(4, typeof(SequenceActionActorGetExeActor), new Point(300, 50));
//         diagram.Nodes.Add(node);
//         node = new StandardNode(5, typeof(SequenceActionActorTypeIDSwitch), new Point(600, 50));
//         diagram.Nodes.Add(node);
//     }
// }
