...
public static class Modmeta
{
    ...
    private static byte[] BuildWeapon(Binmod mod)
    {
        ...
        {
            builder.AppendLine($"modify_gmdl[0]=mod/{mod.ModDirectoryName}/{mod.ModelName}.fbx");
        }
        else
        {
            builder.AppendLine($"modify_gmdl[0]=mod/{mod.ModDirectoryName}/{mod.Model1Name}.fbx");
            builder.AppendLine($"modify_gmdl[1]=mod/{mod.ModDirectoryName}/{mod.Model2Name}.fbx");
        }
    ...
    private static byte[] BuildMultiOutfit(Binmod mod)
    {
        ...
        if (mod.Model2Name == null)
        {
            builder.AppendLine($"gmdl1={mod.ModelName}.fbx");
        }
        else
        {
            builder.AppendLine($"gmdl1={mod.Model1Name}.fbx");
            builder.AppendLine($"gmdl2={mod.Model2Name}.fbx");
        }
