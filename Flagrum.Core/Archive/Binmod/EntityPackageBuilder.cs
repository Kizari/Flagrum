...
public static class EntityPackageBuilder
{
    ...
    private static byte[] BuildMultiModelSinglePreview(Binmod mod)
    {
        ...
        builder.AppendLine($"      <sourcePath_ type=\"string\">mod/{mod.ModDirectoryName}/{mod.Model1Name}.fbx</sourcePath_>");
        builder.AppendLine("    </object>");
        ...
        builder.AppendLine($"      <sourcePath_ type=\"string\">mod/{mod.ModDirectoryName}/{mod.Model2Name}.fbx</sourcePath_>");
        builder.AppendLine("    </object>");
        builder.AppendLine("  </objects>");
        builder.AppendLine("</package>");
        return Encoding.UTF8.GetBytes(builder.ToString());
